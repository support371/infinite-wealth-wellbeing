...
import { AlertTriangle, ArrowUpRight, CheckCircle2, Plug, RefreshCcw, ShieldCheck } from 'lucide-react';
...
export default function ConnectedServicesPage() {
  ...
  const load = useCallback(async () => {
    ...
    setState({ loading: false, error: error?.message || '', connections: data || [] });
