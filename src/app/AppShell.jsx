...
const nav = [
  ...
  { label:'Wellbeing', path:'wellbeing', icon:HeartPulse, module:'wellbeing' },
  { label:'Wealth planning', path:'wealth', icon:TrendingUp, module:'wealth' },
  { label:'Programmes', path:'programmes', icon:BookOpen, module:'programmes' },
  ...
  { label:'Tasks', path:'tasks', icon:ClipboardCheck, module:'tasks' },
  { label:'Resources', path:'resources', icon:BookOpen, module:'resources' },
  { label:'Community', path:'community', icon:Users, module:'community' },
  { label:'Team', path:'team', icon:Users, module:'team', section:'Operations' },
  { label:'Governance', path:'governance', icon:ShieldCheck, module:'governance' },
  { label:'Reports', path:'reports', icon:ClipboardCheck, module:'reports' },
  { label:'Billing', path:'billing', icon:CircleDollarSign, module:'billing' },
  { label:'Integrations', path:'integrations', icon:Building2, module:'integrations' },
